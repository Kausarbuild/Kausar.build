<?php
/**
 * Direct Contact & Consultation Section Template Part
 *
 * Provides three direct functional communication channels:
...
$default_booking_img = studio_build_get_image_src( 'studio_hero_image', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=600&q=80' );
$hero_img            = studio_build_get_image_src( 'studio_booking_portrait', $default_booking_img );
...
$social_instagram    = get_theme_mod( 'studio_social_instagram', 'https://instagram.com/Kausar.build' );
...
$whatsapp_number     = '+916002357235';
$whatsapp_clean      = '916002357235';
$phone_number        = '+916002357235';
$instagram_username  = 'Kausar.build';
...
<section id="book" class="space-y-8 scroll-mt-24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div
            ...
            class="lg:col-span-5 bg-white rounded-3xl border border-neutral-200/80 p-4 sm:p-5 shadow-soft flex flex-col justify-between"
        >
                ...
                <div class="flex items-center justify-center gap-2 text-neutral-600">
                    <?php if ( $social_github ) : ?>
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            class="w-8 h-8 rounded-full border border-neutral-200 hover:border-neutral-400 flex items-center justify-center text-xs text-neutral-700 transition-colors shadow-2xs"
                            aria-label="GitHub"
                        >
        ...
        <div
            ...
            class="lg:col-span-7 bg-white rounded-3xl border border-neutral-200/80 shadow-soft p-5 sm:p-7 flex flex-col justify-between space-y-6"
        >
            <!-- Card Header Banner -->
            <div
                class="p-4 sm:p-5 rounded-2xl flex items-center justify-between text-white transition-colors"
            ...
            >
                <div>
                    ...
                    <p class="text-[11px] text-orange-100 font-mono mt-0.5">
                        Fast response · Available for projects
                    </p>
                </div>
